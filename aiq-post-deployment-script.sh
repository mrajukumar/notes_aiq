...
echo "REPORT_TIMESET: $(sudo jq -r '.REPORT_TIMESET' $userdata)"
...
echo -e "10i REPORT_GENERATION_TIME=$report_generation_time_value\n" | sudo tee -a "$SCHEDULER"
echo "REPORT_GENERATION_TIME After assign: $report_generation_time_value" $SCHEDULER
